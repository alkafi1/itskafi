...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="{{ asset('frontend/image/x-icon" href="assets/images/favicon.ico') }}">
    <!-- CSS 
    ============================================ -->
                ...
                <div class="container">
                    <div class="row row--30 align-items-center">
                        <div class="order-2 order-lg-1 col-lg-7 mt_md--50 mt_sm--50 mt_lg--30">
                            <div class="content">
                                <div class="inner">
                                    <span class="subtitle">{{ $banner->welcome_note }}</span>
                                    <h1 class="title">Hi, I’m <span>{{ $banner->title }}</span><br>
                                        ...
                                        <span class="cd-words-wrapper">
                                                    <b class="is-visible">{{ $banner->designation1 }}</b>
                                                    <b class="is-hidden">{{ $banner->designation2 }}</b>
                                                </span>
                                        </span>
                                        <!-- type headline end -->
                                        </span>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-xl-6 col-md-6 col-sm-6 col-12 m-auto">
                        ...
                        <div class="order-1 order-lg-2 col-lg-5">
                            <div class="thumbnail">
                                <div class="inner">
                                    <img src="{{ asset('/uploads/banner_image')}}/{{ $banner_image->image }}" alt="Personal Portfolio Images">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-left" data-aos="fade-up" data-aos-duration="500" data-aos-delay="100" data-aos-once="true">
                            ...
                            <h2 class="title">What ghhhtgh Do</h2>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="experience-list">
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            ...
                                                            <p class="description"> If you are going to (uses) a passage.
                                                ...
                                                <div class="experience-list">
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            ...
                                                            <p class="description"> If you are going to (usea) a passage.
                                                                Ut tincidunt est ac dolor aliquam sodales.
                                                                Phasellus sed mauris hendrerit, laoreet sem in, lobortis
                                                                mauris hendrerit ante.</p>
                                                        </div>
                                                ...
                                                <div class="experience-list">
                                                    ...
                                                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="700" data-aos-once="true" class="resume-single-list">
                                                        <div class="inner">
                                                            ...
                                                            <p class="description"> If you are going to  a passage.
                                                                Ut tincidunt est ac dolor aliquam sodales.
                                                                Phasellus sed mauris hendrerit, laoreet sem in, lobortis
                                                                mauris hendrerit ante.</p>
                                                        </div>
                                ...
                                <div class="inner">
                                    <div class="card-info">
                                        <div class="card-thumbnail">
                                            <img src="{{ asset('frontend/assets/images/portfolio/portfolio-07.jpg') }}" alt="Testimonial-image">
                                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="news-details">
                            ...
                            <h2 class="title">Digital Marketo to Their  Office.</h2>
                            ...
                            <p>Mauris tempor, orci id pellentesque convallis, massa mi congue eros, sed
                                ...
                                massa nunc quis
                                dui.
                                 ornare varius mi, in vehicula orci scelerisque sed. Fusce a massa
                                nisi.
                                Curabitur sit
                                amet
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-area text-center">
                        ...
                        <p class="description mt--30">© 2021. All rights reserved by <a target="_blank" href="">Rainbow-Themes.</a></p>
                    </div>
                </div>
            </div>
        </div>
